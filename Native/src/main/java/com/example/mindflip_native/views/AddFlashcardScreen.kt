    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("e.g. What is the capital of Japan?", color = Color.Black.copy(alpha = 0.3f)) },
                ...
                colors = OutlinedTextFieldDefaults.colors(focusedBorderColor = Color(0xFF1280ED))
            )
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("e.g. Tokyo", color = Color.Black.copy(alpha = 0.3f)) },
